<div <?php echo " class='con-6310-noslider con-6310-noslider-" . esc_attr($ids) . "' "; ?>>
   <?php
   ...
   ?>
         <div class="con-6310-col-list con-6310-col-<?php echo esc_attr($cssData['desktop_item_per_row']) ?>">
            <div class="con-6310-template-<?php echo esc_attr($ids) ?>">
               <div class="con-6310-template-<?php echo esc_attr($ids) ?>-wrapper">
                  <div class="con-6310-template-<?php echo esc_attr($ids) ?>-left-section" style=" background: url('<?php echo $value->sideimage?>')"></div>
                     <div class="con-6310-template-<?php echo esc_attr($ids) ?>-right-section">
                           <?php con_6310_display_icon($ids, esc_attr($value->icontype), esc_attr($value->icons), '', '', '') ?>
                           ...
                           <div class="con-6310-template-<?php echo esc_attr($ids) ?>-title"><?php echo con_6310_replace(esc_attr($value->title)) ?>
                           </div>              
                     </div>                   
                  </div>
               </div>
