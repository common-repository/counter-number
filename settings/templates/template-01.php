<div <?php echo " class='con-6310-noslider con-6310-noslider-" . esc_attr($templateId) . "' "; ?>>
   <?php
   ...
   ?>
         <div class="con-6310-col-list con-6310-col-<?php echo esc_attr($cssData['desktop_item_per_row']) ?>">
            <div class="con-6310-template-<?php echo esc_attr($templateId) ?>">
               <div class="con-6310-template-<?php echo esc_attr($templateId) ?>-wrapper">
                  <div class="con-6310-template-<?php echo esc_attr($templateId) ?>-left-section" style=" background: url('<?php echo $value->sideimage?>')"></div>
                     <div class="con-6310-template-<?php echo esc_attr($templateId) ?>-right-section">
                           ...
                           <div class="con-6310-template-<?php echo esc_attr($templateId) ?>-title"><?php echo con_6310_replace(esc_attr($value->title)) ?>
                           </div>
