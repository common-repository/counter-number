   ...
   ?>
         <div class="con-6310-col-list con-6310-col-<?php echo esc_attr($cssData['desktop_item_per_row']) ?> ">
            <div class="con-6310-template-<?php echo esc_attr($templateId) ?>">
               <div class="con-6310-template-<?php echo esc_attr($templateId) ?>-circle">
                  <div class="con-6310-template-<?php echo esc_attr($templateId) ?>-container">
                     <div class="con-6310-template-<?php echo esc_attr($templateId) ?>-content">                    
