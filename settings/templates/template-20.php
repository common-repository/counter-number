   ...
   ?>
         <div class="con-6310-col-list con-6310-col-<?php echo esc_attr($cssData['desktop_item_per_row']) ?> ">
            <div class="con-6310-template-<?php echo esc_attr($templateId) ?>">
               <div class="con-6310-template-<?php echo esc_attr($templateId) ?>-counter-icon">
               ...
               <div class="con-6310-template-<?php echo esc_attr($templateId) ?>-counter-content">
                  ...
                  <div class="con-6310-template-<?php echo esc_attr($templateId) ?>-title">
                     <?php echo con_6310_replace(esc_attr($value->title)) ?>
                  </div>
                  <div class="con-6310-template-<?php echo esc_attr($templateId) ?>-description">
                     <?php echo con_6310_replace(esc_attr($value->description)) ?>
                  </div>
                  <div class="con-6310-template-<?php echo esc_attr($templateId) ?>-read-more">
