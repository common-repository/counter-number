        ...
        <div class="row con_6310_padding_15_px">
          ...
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">
              ...
              <tr>
                <td><b> 1st Box Outer Background</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_box_outer_1_background" id="con_6310_box_outer_1_background" class="con-6310-form-input con_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['con_6310_box_outer_1_background']) ?>">
                </td>
              </tr> 
              <tr>
                <td><b> 2nd Box Outer Background</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_box_outer_2_background" id="con_6310_box_outer_2_background" class="con-6310-form-input con_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['con_6310_box_outer_2_background']) ?>">
                </td>
              </tr> 
              <tr>
                <td><b> 3rd Box Outer Background</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_box_outer_3_background" id="con_6310_box_outer_3_background" class="con-6310-form-input con_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['con_6310_box_outer_3_background']) ?>">
                </td>
              </tr> 
              <tr>
                <td><b> 4th Box Outer Background</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_box_outer_4_background" id="con_6310_box_outer_4_background" class="con-6310-form-input con_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['con_6310_box_outer_4_background']) ?>">
                </td>
              </tr> 
              <tr>
                <td><b> 5th Box Outer Background</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_box_outer_5_background" id="con_6310_box_outer_5_background" class="con-6310-form-input con_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['con_6310_box_outer_5_background']) ?>">
                </td>
              </tr> 
              <tr>
                <td><b> 6th Box Outer Background</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_box_outer_6_background" id="con_6310_box_outer_6_background" class="con-6310-form-input con_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['con_6310_box_outer_6_background']) ?>">
                </td>
              </tr>                 
            </table>
          </div>
