        ...
        <div class="row con_6310_padding_15_px">
          ...
          <table class="table table-responsive con_6310_admin_table">
              ...
              <tr>
                ...
                <td>
                  <input type="number" min="0" name="con_6310_box_circle_width" value="<?php echo esc_attr($cssData['con_6310_box_circle_width']) ?>" class="con-6310-form-input" step="1" id="con_6310_box_circle_width" />
                </td>
              </tr> 
              <tr>
                <td><b>Outer circle border size </b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                <td>
                  <input type="number" min="0" name="con_6310_outer_circle_border_size" value="<?php echo esc_attr($cssData['con_6310_outer_circle_border_size']) ?>" class="con-6310-form-input" step="1" id="con_6310_outer_circle_border_size" />
                </td>
              </tr>          
              <tr>
                <td><b>Inner circle border size </b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
                  <input type="number" min="0" name="con_6310_inner_circle_border_size" value="<?php echo esc_attr($cssData['con_6310_inner_circle_border_size']) ?>" class="con-6310-form-input" step="1" id="con_6310_inner_circle_border_size" />
                </td>
              </tr>
            </table>
          </div>
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">
            <tr>
                <td width="55%"><b>Inner circle 1st color</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
                  <input type="text" name="con_6310_inner_1st_circle_color" id="con_6310_inner_1st_circle_color" class="con-6310-form-input con_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['con_6310_inner_1st_circle_color']) ?>">
                </td>
              </tr>
              <tr>
                <td width="55%"><b>Inner circle 2nd color</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
                  <input type="text" name="con_6310_inner_2nd_circle_color" id="con_6310_inner_2nd_circle_color" class="con-6310-form-input con_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['con_6310_inner_2nd_circle_color']) ?>">
                </td>
              </tr>
              <tr>
...
<?php
$jsCode = "jQuery(document).ready(function(){jQuery('#tab5').hide();});";
wp_register_script( "con-6310-template-icon-tab-hide", "" );
wp_enqueue_script( "con-6310-template-icon-tab-hide" );
wp_add_inline_script( "con-6310-template-icon-tab-hide", $jsCode );
?>