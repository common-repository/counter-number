      ...
      <div id="tab-1">
        <div class="row con_6310_padding_15_px">
          ...
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">
            <tr>
                <td><b>Box Inner Background</b>  <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="con_6310_box_inner_background_color" id="con_6310_box_inner_background_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_box_inner_background_color']) ?>">
                </td>
              </tr>
              <tr>
                <td width="55%"><b>Box Inner Hover Background</b>  <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="con_6310_box_inner_background_hover_color" id="con_6310_box_inner_background_hover_color" class="con-6310-form-input con_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['con_6310_box_inner_background_hover_color']) ?>">
                </td>
              </tr>    
              <tr>
                <td width="55%"><b>Box 1st Outer Background</b>  <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="con_6310_box_outer_1st_background_color" id="con_6310_box_outer_1st_background_color" class="con-6310-form-input con_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['con_6310_box_outer_1st_background_color']) ?>">
                </td>
              </tr>   
              <tr>
                <td width="55%"><b>Box 2nd Outer Background</b>  <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="con_6310_box_outer_2nd_background_color" id="con_6310_box_outer_2nd_background_color" class="con-6310-form-input con_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['con_6310_box_outer_2nd_background_color']) ?>">
                </td>
              </tr> 
              <tr>
                <td width="55%"><b>Box 3rd Outer Background</b>  <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="con_6310_box_outer_3rd_background_color" id="con_6310_box_outer_3rd_background_color" class="con-6310-form-input con_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['con_6310_box_outer_3rd_background_color']) ?>">
                </td>
              </tr> 
              <tr>
                <td width="55%"><b>Box 4th Outer Background</b>  <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="con_6310_box_outer_4th_background_color" id="con_6310_box_outer_4th_background_color" class="con-6310-form-input con_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['con_6310_box_outer_4th_background_color']) ?>">
                </td>
              </tr>        
        ...
        <div class="row">
          ...
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">
              ...
              <tr>
                <td><b>Line Height</b>  <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
              ...
              <tr>
                <td><b>Font Weight</b>  <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
          ...
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">
              ...
              <tr>
                <td><b>Text Transform</b>  <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
              ...
              <tr>
                <td><b>Text Align</b>  <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
              ...
              <tr>
                <td><b>Padding Top</b>  <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
              ...
              <tr>
                <td><b>Padding Bottom</b>  <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
        ...
        <div class="row">
          ...
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">            
              ...
              <tr>
                <td><b>Icon Color</b> <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
              ...
              <tr>
                <td><b>Icon Hover Color</b> <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
...
<?php
$jsCode = "jQuery(document).ready(function(){jQuery('#tab4, #tab6').hide();});";
wp_register_script( "con-6310-template-tab-hide", "" );
wp_enqueue_script( "con-6310-template-tab-hide" );
wp_add_inline_script( "con-6310-template-tab-hide", $jsCode );
?>