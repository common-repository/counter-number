        ...
        <div class="row con_6310_padding_15_px">
          ...
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">
              ...
              <tr>
                <td width="55%"><b>Box Hover Overly Color</b></td>
                <td>
                  <input type="text" name="con_6310_box_hover_overly_color" id="con_6310_box_hover_overly_color" class="con-6310-form-input con_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr($cssData['con_6310_box_hover_overly_color']) ?>">
                </td>
              </tr>
              <tr>
