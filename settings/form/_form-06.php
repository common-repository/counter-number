        ...
        <div class="row con_6310_padding_15_px">
          ...
          <table class="table table-responsive con_6310_admin_table">
              ...
              <tr>
                ...
                <td>
                  <input type="number" min="0" name="con_6310_border_radius" value="<?php echo  esc_attr($cssData['con_6310_border_radius']) ?>" class="con-6310-form-input" id="con_6310_border_radius" />
                </td>
              </tr>  
            </table>
          </div>
          <div class="con-6310-col-50">
            ...
            <tr>
              ...
              <tr>
                <td><b>Inner Border width </b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
                  <input type="number" min="0" name="con_6310_inner_border_size" value="<?php echo esc_attr($cssData['con_6310_inner_border_size']) ?>" class="con-6310-form-input" step="1" id="con_6310_inner_border_size" />
                </td>
              </tr>          
              <tr>
