          ...
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="con_6310_1_box_background_color" id="con_6310_1_box_background_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_1_box_background_color']) ?>">
                </td>
              </tr>         
            </table>
          </div>
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">      
              <tr>
                ...
                <td>
                  <input type="text" name="con_6310_2_box_background_color" id="con_6310_2_box_background_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_2_box_background_color']) ?>">
                </td>
              </tr>  
              <tr>
                ...
                <td>
                  <input type="text" name="con_6310_3_box_background_color" id="con_6310_3_box_background_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_3_box_background_color']) ?>">
                </td>
              </tr>   
              <tr>
                ...
                <td>
                  <input type="text" name="con_6310_4_box_background_color" id="con_6310_4_box_background_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_4_box_background_color']) ?>">
                </td>
              </tr>  
              <tr>
                ...
                <td>
                  <input type="text" name="con_6310_5_box_background_color" id="con_6310_5_box_background_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_5_box_background_color']) ?>">
                </td>
              </tr>      
              <tr>
                ...
                <td>
                  <input type="text" name="con_6310_6_box_background_color" id="con_6310_6_box_background_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_6_box_background_color']) ?>">
                </td>
              </tr>    
              <tr>
                <td><b>Box Hover Background</b><div class="con-6310-no-live-preview">Live Preview Not Available</div>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
                  <input type="text" name="con_6310_box_hover_background_color" id="con_6310_box_hover_background_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_box_hover_background_color']) ?>">
                </td>
              </tr> 
              <tr>
