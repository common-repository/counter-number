        ...
        <div class="row con_6310_padding_15_px">
          ...
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">
              ...
              <tr>
                <td><b>Outer Background Color Top</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
                  <input type="text" name="con_6310_outer_background_color_top" id="con_6310_outer_background_color_top" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_outer_background_color_top']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>Outer Background Color Bottom</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
                  <input type="text" name="con_6310_outer_background_color_bottom" id="con_6310_outer_background_color_bottom" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_outer_background_color_bottom']) ?>">
                </td>
              </tr>
            </table>
          </div>
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">
              <tr>
                <td><b>Outer Background Hover Color Top</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
                  <input type="text" name="con_6310_outer_background_hover_color_top" id="con_6310_outer_background_hover_color_top" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_outer_background_hover_color_top']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>Outer Background Hover Color Bottom</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
                  <input type="text" name="con_6310_outer_background_hover_color_bottom" id="con_6310_outer_background_hover_color_bottom" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_outer_background_hover_color_bottom']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>Inner Background Color Top</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
                  <input type="text" name="con_6310_inner_background_color_top" id="con_6310_inner_background_color_top" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_inner_background_color_top']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>Inner Background Color Bottom</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
                  <input type="text" name="con_6310_inner_background_color_bottom" id="con_6310_inner_background_color_bottom" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_inner_background_color_bottom']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>Inner Background Hover Color Top</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
                  <input type="text" name="con_6310_inner_background_hover_color_top" id="con_6310_inner_background_hover_color_top" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_inner_background_hover_color_top']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>Inner Background Hover Color Bottom</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
                  <input type="text" name="con_6310_inner_background_hover_color_bottom" id="con_6310_inner_background_hover_color_bottom" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_inner_background_hover_color_bottom']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>After Effect Color</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
                  <input type="text" name="con_6310_after_effect_color" id="con_6310_after_effect_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_after_effect_color']) ?>">
                </td>
              </tr>
              <tr>
