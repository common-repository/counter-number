        ...
        <div class="row con_6310_padding_15_px">
          ...
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">
              ...
              <tr>
                <td><b>1st circle Background color</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_1_circle_background_color" id="con_6310_1_circle_background_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_1_circle_background_color']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>2nd Box Background color</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_2_circle_background_color" id="con_6310_2_circle_background_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_2_circle_background_color']) ?>">
                </td>
              </tr>
            </table>
          </div>
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">
              <tr>
                <td><b>3rd Box Background color</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_3_circle_background_color" id="con_6310_3_circle_background_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_3_circle_background_color']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>4th Box Background color</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_4_circle_background_color" id="con_6310_4_circle_background_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_4_circle_background_color']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>5th Box Background color</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_5_circle_background_color" id="con_6310_5_circle_background_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_5_circle_background_color']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>6th Box Background color</b>
                <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_6_circle_background_color" id="con_6310_6_circle_background_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_6_circle_background_color']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>Border color</b>
                ...
                <td>
                  <input type="text" name="con_6310_box_border_color" id="con_6310_box_border_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_box_border_color']) ?>">
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <input type="number" min="0" name="con_6310_box_circle_size" value="<?php echo esc_attr($cssData['con_6310_box_circle_size']) ?>" class="con-6310-form-input" step="1" id="con_6310_box_circle_size" />
                </td>
              </tr>
            </table>
          </div>
