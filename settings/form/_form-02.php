      ...
      <div id="tab-1">
        <div class="row con_6310_padding_15_px">
          ...
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">
              ...
              <tr>
                ...
                <td>
                  <input type="number" min="0" name="con_6310_box_border_size" value="<?php echo esc_attr($cssData['con_6310_box_border_size']) ?>" class="con-6310-form-input" step="1" id="con_6310_box_border_size" />
                </td>
              </tr>              
            </table>
          </div>
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">
            <tr>
                <td><b>1st Border Color</b>
                <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_box_1_border_color" id="con_6310_box_1_border_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_box_1_border_color']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>2nd Border Color</b> <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_box_2_border_color" id="con_6310_box_2_border_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_box_2_border_color']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>3rd Border Color</b> <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                  <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_box_3_border_color" id="con_6310_box_3_border_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_box_3_border_color']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>4th Border Color</b> <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                  <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_box_4_border_color" id="con_6310_box_4_border_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_box_4_border_color']) ?>">
                </td>
              </tr>
              <tr>
                <td><b>5th Border Color</b> <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                 <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_box_5_border_color" id="con_6310_box_5_border_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_box_5_border_color']) ?>">
                </td>
              </tr> 
              <tr>
                <td><b>6th Border Color</b> <span class="con-6310-pro">(Pro) <div class="con-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                  <div class="con-6310-no-live-preview">Live Preview Not Available</div>
                </td>
                <td>
                  <input type="text" name="con_6310_box_6_border_color" id="con_6310_box_6_border_color" class="con-6310-form-input con_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['con_6310_box_6_border_color']) ?>">
                </td>
              </tr> 
              <tr>
        ...
        <div class="row">
          ...
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">
              ...
              <tr class="con-6310-title-font-hover-color">
        ...
        <div class="row">
          ...
          <div class="con-6310-col-50">
            <table class="table table-responsive con_6310_admin_table">
              ...
              <tr class="con-6310-icon-hover-color">
              ...
              <tr class="title-act-field">
                ...
                <td>
                  <input type="number" min="0" name="con_6310_border_font_size" value="<?php echo esc_attr($cssData['con_6310_border_font_size']) ?>" class="con-6310-form-input" step="1" id="con_6310_border_font_size" />
                </td>
              </tr>
              <tr>
              ...
              <tr class="title-act-field">
                <td><b>Icon Position (Left / Right)</b></td>
                <td>
                  <input type="number" name="con_6310_icon_position" value="<?php echo esc_attr($cssData['con_6310_icon_position']) ?>" class="con-6310-form-input" step="1" id="con_6310_icon_position" />
                </td>
              </tr>
            </table>
          </div>
...
<?php
$jsCode = "jQuery(document).ready(function(){jQuery('.con-6310-hide-title-color, .con-6310-title-font-hover-color, .con-6310-icon-hover-color, .con-6310-hide-font-value-color, .con-6310-hide-font-value-hover-color, .con_6310_number_prefix_font_color-hide, .con_6310_number_prefix_font_hover_color-hide, .con_6310_number_suffix_font_color-hide, .con_6310_number_suffix_font_hover_color-hide').hide();});";
